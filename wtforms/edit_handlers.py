...
class BaseWtFormSubmissionsPanel(EditHandler):
    template = "wtforms/admin/edit_handlers/form_responses_panel.html"

    def render(self):
        from .models import WtFormSubmission
        submissions = WtFormSubmission.objects.filter(page=self.instance)
...
class WtFormSubmissionsPanel(object):
